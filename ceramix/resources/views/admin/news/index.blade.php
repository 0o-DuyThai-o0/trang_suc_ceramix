					...
					<tr class="x-hover">
						...
						<td style="width: 10px;" class="text-center"><?php echo $i; ?></td>
						 <td style="font-size: 13px;"><a href="{{ asset('admin/news') }}/{{$new->id}}/edit">{{$new->name}}</a>
                             <div class="action-x">
                                 <a href="./<?php echo $new->new_alias?>" target="_blank">  <button type="button" data-toggle="tooltip" title="Xem ngay !" class="btn btn-info btn-round btn-just-icon btn-sm" data-original-title="" title="">
                                         <i class="fa fa-file-text" aria-hidden="true"></i>
                                     </button>
                                 </a>
                                 <a href="./news/{{$new->id}}/edit"><button type="button" data-toggle="tooltip" title="Chỉnh sửa !" class="btn btn-success btn-round btn-just-icon btn-sm" data-original-title="" title="">
