...
-->
				...
				<div class="row add-user">
					...
					<div class="col-md-11">
					        <textarea id="price_new" name="price_new"> {{$product->price}} </textarea>
						<script>CKEDITOR.replace('price');</script>
				...
				<div class="row add-user">
					...
					<div class="col-md-11">
					        <textarea id="price_old" name="price_old"> {{$product->price_old}} </textarea>
						<script>CKEDITOR.replace('price');</script>
