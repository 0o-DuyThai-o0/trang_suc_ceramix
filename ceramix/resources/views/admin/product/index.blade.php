                    ...
                    <tbody>
                        ...
                        <tr class="x-hover">
                            ...
                            <td style="font-size: 13px;"><a href="/admin/product/<?php echo $product->id ?>/edit">{{ $product->name }}</a>
                             <div class="action-2">
                                 <a href="../<?= $product->product_alias;?>" target="_blank">  <button type="button" data-toggle="tooltip" title="Xem ngay !" class="btn btn-info btn-round btn-just-icon btn-sm" data-original-title="" title="">
                                         <i class="fa fa-file-text" aria-hidden="true"></i>
                                     </button>
                                 </a>
                                 <a href="../admin/product/<?php echo $product->id ?>/edit"><button type="button" data-toggle="tooltip" title="Chỉnh sửa !" class="btn btn-success btn-round btn-just-icon btn-sm" data-original-title="" title="">
