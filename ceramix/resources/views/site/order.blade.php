...
<div class="container">
    ...
    <form action="mycart/update" method="POST">
        ...
        <a href="./" class="btn-order btn btn-primary ml-3 pt-2 mt-3">Quay lại</a>
			...
			<div class="btn float-right btn-total mr-4 mb-4">
				<b>Tổng tiền</b><br>
				<div class="total-price ">{{ number_format($total) }}<span class="vnd ml-2">đ</span></div>
			</div>
    </form>
      ...
      <div class="row mt-4">
        <div class="col-md-4">
          <div class="wd-100_dp-ib pd-bt-20">
            ...
            <div class="user_info-item" style="margin:10px 0;">
				<span class="txt2" style="margin-right:10px;">Họ tên*</span>
                <input type="text" name="ho_ten" id="buyer_name" value="" required="">
                <label class="error err" generated="true" for="user_info[name]" style="color:red"></label> 
                <input type="hidden" name="user_info[sanpham]" value="">
            </div>
            <div class="user_info-item" style="margin:10px 0;">
				<span class="txt2">Email*</span>
                <input class="form-cs kt-bd-input-cart" type="email" name="email" id="buyer_email" value="" required="">
                 <label class="error err" generated="true" for="email" style="color:red"></label> 
            </div>
            <div class="user_info-item" style="margin:10px 0;">  
				<span class="txt2">Số điện thoại*</span>
                <input class="form-cs kt-bd-input-cart" type="number" name="so_dt" id="buyer_mobile" value="" required="">
                 <label class="error err" generated="true" for="phone" style="color:red"></label>

            </div>
                  <div class="item-form d- user_info-item user_province" style="margin:10px 0;">
                            <span class="txt2">Tỉnh/Thành phố</span>
                            <span class="custom-province " style="width: 70%;">
                      <select name="noi_dung"  id="buyer_province" onchange="getDistrict(this.value)" required="" class="form-cs kt-bd-input-cart">
                    ...
                    <div class="user_info-item" style="margin:10px 0;"> <span class="txt2" style="margin-right:10px">Địa chỉ*</span>
                            <textarea id="buyer_address" name="user_info[address]" required=""></textarea>
                        </div>
					<div class="user_info-item" style="margin:10px 0;"><span class="txt2" style="margin-right:10px">Ghi chú</span>
                            <input name="ghi_chu" id="buyer_note" style="height:100px">
                        </div>
                   </div>
                  </div>
                  <div class="col-md-4">
                    ...
                    <div class="col-md-4">
                        ...
                        <table class="tong-so-tien-can-thanh-toan">
							...
							<tr>
								<input type="text" id="country" name="tong_tien" value="{{ number_format($total) }}" readonly><br><br>
