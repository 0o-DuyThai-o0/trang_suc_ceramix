			        ...
			        foreach( $menu_items as $menu_item1 ) {
						...
						<?php
								 foreach( $menu_items as $menu_item2 ) {
									...
									<a class="show-1" href="/admin/menusitem/<?php echo $menu_item2->id ?>/edit"> edit						</a>
										</td>
			        	...
			        	<tr class="<?php if($item->parent_id == 0 ){ echo "parent";}?> x-hover">
			        		...
			        		<td>
			        			...
			        			<div class="action">
                                 ...
                                 <a href="/admin/cat-new/<?php echo $item->id ?>/edit"><button type="button" data-toggle="tooltip" title="Chỉnh sửa !" class="btn btn-success btn-round btn-just-icon btn-sm" data-original-title="" title="">
                                         <i class="fa fa-pencil-square-o" aria-hidden="true"></i>
                                     </button>
                                 </a>
                             </div>
...
function showCategories_menu_top_skin_care ($khach_truy_cap_all_array, $char = '') {
	foreach ($khach_truy_cap_all_array as $key =>$mang) {
						 $dropdown='header__drop-item';
						 $span_caret='';
						 $dropdown_a ='header__drop-item-link';
						 $dropdown_submenu = '';
						$link_con='';
					   
						unset($khach_truy_cap_all_array[$key]); 
						echo "<li class='".$dropdown."'> <a class='".$dropdown_a."' .$link_con. href='.".$mang['href']."'>".$mang['text'].$span_caret."</a>";
						echo "</li>";
					}					
}
