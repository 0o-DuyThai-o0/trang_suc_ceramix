...
class AppServiceProvider extends ServiceProvider {
    ...
    $bat_ca_shbet=DB::table('product')->where('cat_id', 'LIKE', "%-582-%")->where('status_product','=',1 )->paginate(6);
	$bat_ca_shbet2=DB::table('product')->where('cat_id', 'LIKE', "%-583-%")->where('status_product','=',1 )->paginate(6);
	$bat_ca_shbet3=DB::table('product')->where('cat_id', 'LIKE', "%-584-%")->where('status_product','=',1 )->paginate(6);
	...
	//   $son="1";
		...
		View::share('bat_ca_shbet2', $bat_ca_shbet2);
		View::share('bat_ca_shbet3', $bat_ca_shbet3);
		View::share('list_articles_cat2', $list_articles_cat2);
		View::share('list_articles_cat3', $list_articles_cat3);
