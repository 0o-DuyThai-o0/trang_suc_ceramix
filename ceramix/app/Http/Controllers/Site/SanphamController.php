...
$trang_chu=DB::table('product')->where('id', '=', "856")->where('status_product','=',1 )->get();
	...
	$bat_ca_shbet2=DB::table('product')->where('cat_id', 'LIKE', "%-583-%")->where('status_product','=',1 )->take(20)->get();
	
	$list_articles_cat2 = DB::table('product')->where('cat_id', 'LIKE', "%-583-%")->orderBy('id', 'ASC')->where('status_product','=','1')->get();
	
	$bat_ca_shbet3=DB::table('product')->where('cat_id', 'LIKE', "%-584-%")->where('status_product','=',1 )->take(20)->get();
	
	$list_articles_cat3 = DB::table('product')->where('cat_id', 'LIKE', "%-584-%")->orderBy('id', 'ASC')->where('status_product','=','1')->get();
	
    $jotun=DB::table('product')->where('cat_id', 'LIKE', "%-563-%")->where('status_product','=',1 )->take(20)->orderBy(DB::raw('RAND()'))->get();
    ...
    return view('site.index')->with('bai_viet_quan_trong',$bai_viet_quan_trong)->with('jotun',$jotun)->with('bat_ca_shbet',$bat_ca_shbet)->with('bat_ca_shbet2',$bat_ca_shbet2)->with('bat_ca_shbet3',$bat_ca_shbet3)->with('list_articles_cat3',$list_articles_cat3)->with('list_articles_cat2',$list_articles_cat2)->with('sika',$sika)->with('sp_noi_bat',$sp_noi_bat)->with('gach_xd',$gach_xd)->with('cat_xd',$cat_xd)->with('da_xd',$da_xd)->with('ton_ma_mau',$ton_ma_mau)->with('xi_mang',$xi_mang)->with('tran_nhua',$tran_nhua)->with("tran_xuyen_sang",$tran_xuyen_sang)->with('nhom_kinh',$nhom_kinh)->with('trang_chu',$trang_chu);
}

public function cat_phantrang()
{ 
	$trang_chu=DB::table('product')->where('id', '=', "856")->where('status_product','=',1 )->get();
	...
	$list_articles_cat = DB::table('product')->where('cat_id', 'LIKE', "%-583-%")->orderBy('id', 'ASC')->where('status_product','=','1')->get();
    ...
    return view('site.cat')->with('bai_viet_quan_trong',$bai_viet_quan_trong)->with('jotun',$jotun)->with('bat_ca_shbet',$bat_ca_shbet)->with('bat_ca_shbet2',$bat_ca_shbet2)->with('bat_ca_shbet3',$bat_ca_shbet3)->with('list_articles_cat3',$list_articles_cat3)->with('list_articles_cat',$list_articles_cat)->with('sika',$sika)->with('sp_noi_bat',$sp_noi_bat)->with('gach_xd',$gach_xd)->with('cat_xd',$cat_xd)->with('da_xd',$da_xd)->with('ton_ma_mau',$ton_ma_mau)->with('xi_mang',$xi_mang)->with('tran_nhua',$tran_nhua)->with("tran_xuyen_sang",$tran_xuyen_sang)->with('nhom_kinh',$nhom_kinh)->with('trang_chu',$trang_chu);
}
...
public function xoa_anh_ajax_news_edit(Request $request) {
 ...
 public function update_quantity(Request $request){
    ...
    public function cart_show_product(){
        ...
        $product_all = DB::table('product')->where('status_product','=','1')->get();
        return view('site.order')->with('product_all',$product_all);
    }
...
public function get_form__input_search ($form__input_search) {
	...
	return view('site.search_site') -> with('products', $products) -> with('cats', $cats) -> with('cat_name', $cat_name) -> with('product_all', $product_all)
